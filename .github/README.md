...
[`@aws-sdk/client-cloudtrail-data`](https://www.npmjs.com/package/@aws-sdk/client-cloudtrail-data/v/3.1052.0).
...
- @aws-sdk/client-cloudtrail-data v3.1052.0 - [https://cloud-sdk-builds.github.io/?sdk=client-cloudtrail-data&version=3.1052.0](https://cloud-sdk-builds.github.io/?sdk=client-cloudtrail-data&version=3.1052.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudtrail-data@3.1052.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-erTdmKQOglPKRXLjqeaN94Vy9szHGphyyG5n0elbtwFXCnLO3NmCLVMPbQ0VoHZl
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudtrail-data/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudtrail-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudtrail-data@3.1052.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudtrail-data@3.1052.0/index.min.mjs": "sha384-erTdmKQOglPKRXLjqeaN94Vy9szHGphyyG5n0elbtwFXCnLO3NmCLVMPbQ0VoHZl"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-cloudtrail-data";
...
```
https://github.com/cloud-sdk-builds/client-cloudtrail-data/blob/refs/tags/3.1052.0/LICENSE
```
