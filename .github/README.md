...
[`@aws-sdk/client-cloudtrail-data`](https://www.npmjs.com/package/@aws-sdk/client-cloudtrail-data/v/3.1134.0).
...
- @aws-sdk/client-cloudtrail-data v3.1134.0 - [https://cloud-sdk-builds.github.io/?sdk=client-cloudtrail-data&version=3.1134.0](https://cloud-sdk-builds.github.io/?sdk=client-cloudtrail-data&version=3.1134.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudtrail-data@3.1134.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6hLlmLoEmZwNPP50TvWEdbzxx1qHOeYWcUwhZetAlh/4e4y62zUuGFSdacoa2QhE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudtrail-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudtrail-data@3.1134.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudtrail-data@3.1134.0/index.min.mjs": "sha384-6hLlmLoEmZwNPP50TvWEdbzxx1qHOeYWcUwhZetAlh/4e4y62zUuGFSdacoa2QhE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudtrail-data/blob/refs/tags/3.1134.0/LICENSE
```
