...
[`@aws-sdk/client-cloudtrail-data`](https://www.npmjs.com/package/@aws-sdk/client-cloudtrail-data/v/3.713.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudtrail-data@3.713.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NMnWsxNNNoGFdMyJl7LBRrLIVxv+MF1vGZWo7tjGYzR6gIIeNq0VjkRaDnHwEo3K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudtrail-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudtrail-data@3.713.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudtrail-data@3.713.0/index.min.mjs": "sha384-NMnWsxNNNoGFdMyJl7LBRrLIVxv+MF1vGZWo7tjGYzR6gIIeNq0VjkRaDnHwEo3K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudtrail-data/blob/refs/tags/3.713.0/LICENSE
```
